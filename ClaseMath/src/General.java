public class General {
    public static void main(String[] args) {
       ...
       // System.out.println("Math.log(2,71) = " + Math.log(2,7));
       ...
       // System.out.println("Math.floor(2,9) = " + Math.floor(2,9));
        ...
        System.out.println("Math.abs(2.3) = " + Math.abs(2.3)); //este metodo esta sobrecargado
        System.out.println("Math.abs(2.3) = " + Math.abs(-2.3));
        System.out.println("Math.exp(1) = " + Math.exp(1));  //potencia de e
